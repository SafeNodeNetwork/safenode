...
This mechanism has been integrated into Bitcore-Node-SafeNode which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/safenodecoin/insight-api-safenode#web-socket-api](https://github.com/safenodecoin/insight-api-safenode#web-socket-api) 
* API: [https://github.com/safenodecoin/insight-api-safenode#instantsend-transactions](https://github.com/safenodecoin/insight-api-safenode#instantsend-transactions) 
...
By default, the SafeNode daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SafeNode daemon:
