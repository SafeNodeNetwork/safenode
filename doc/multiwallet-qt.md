...
Only requiring some minor changes is safenode.cpp.
...
Changes to safenode.cpp
----------------------
safenode.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
