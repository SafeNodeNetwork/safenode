...
SafeNode is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadCheckDarkSendPool : Runs safenode list and sync data update loops
...
However, in open source software such as SafeNode, where everyone uses
...
pay attention to for reviewers of SafeNode code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: SafeNode uses tinyformat, which is type safe. Leave them out to avoid confusion
