...
CDarkSendRelay::CDarkSendRelay(CTxIn& vinSafenodeIn, vector<unsigned char>& vchSigIn, int nBlockHeightIn, int nRelayTypeIn, CTxIn& in2, CTxOut& out2)
{
...
{
    CSafenode* pmn = mnodeman.GetSafenodeByRank(nRank, nBlockHeight, MIN_PRIVATESEND_PEER_PROTO_VERSION);
