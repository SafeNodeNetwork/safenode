/* src/config/safenode-config.h.  Generated from safenode-config.h.in by configure.  */
/* src/config/safenode-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The SafeNode developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "SafeNode"
...
#define PACKAGE_BUGREPORT "https://github.com/safenodecoin/safenodecoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "SafeNode"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "SafeNode 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "safenode"
