...
/**
 * SafeNode RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue safenode(const UniValue& params, bool fHelp);
extern UniValue safenodelist(const UniValue& params, bool fHelp);
extern UniValue safenodebroadcast(const UniValue& params, bool fHelp);
