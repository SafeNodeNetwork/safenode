...
enum AvailableCoinsType
{
    ...
    ONLY_5000 = 5, // find safenode outputs including locked ones (use with caution)
...
public:
    ...
    /// Get 2500 SXN output and keys which can be used for the Safenode
    bool GetSafenodeVinAndKeys(CTxIn& txinRet, CPubKey& pubKeyRet, CKey& keyRet, std::string strTxHash = "", std::string strOutputIndex = "");
