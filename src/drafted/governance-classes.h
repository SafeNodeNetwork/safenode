 ...
 *
 *   // network
 *   CSafeNodeNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.safenodecoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSafeNodeNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CSafeNodeNetwork(UniValue objIn)
    {
...
// // can be under: SafeNodeNetwork
// //   -- signature requirements : Key1(User)
// class CSafeNodeNetworkVariable : public CGovernanceObject
// {
// private:
