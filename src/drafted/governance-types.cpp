...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SafeNodeNetwork") type = SafeNodeNetwork;
    if(strType == "SafeNodeNetworkVariable") type = SafeNodeNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SafeNodeNetwork) s = "SafeNodeNetwork";
    if(type == SafeNodeNetworkVariable) s = "SafeNodeNetworkVariable";
