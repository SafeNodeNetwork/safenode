...
// fConnectToSafenode should be 'true' only if you want this node to allow to connect to itself
// and/or you want it to be disconnected on CSafenodeMan::ProcessSafenodeConnections()
CNode* ConnectNode(CAddress addrConnect, const char *pszDest = NULL, bool fConnectToSafenode = false);
...
public:
    ...
    bool fRelayTxes;
    // If 'true' this node will be disconnected on CSafenodeMan::ProcessSafenodeConnections()
    bool fSafenode;
    CSemaphoreGrant grantOutbound;
    CSemaphoreGrant grantSafenodeOutbound;
