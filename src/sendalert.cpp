...
2. run safenoded with -printalert or -sendalert like this:
   /path/to/safenoded -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://safenodecoin.io";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/SafeNode:0.12.0.58/"));
