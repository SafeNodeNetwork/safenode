...
QString ClientModel::getSafenodeCountString() const
{
...
{
    QString newSafenodeCountString = getSafenodeCountString();

    if (cachedSafenodeCountString != newSafenodeCountString)
    {
        cachedSafenodeCountString = newSafenodeCountString;

        Q_EMIT strSafenodesChanged(cachedSafenodeCountString);
    }
}
