    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SXN-light"), QVariant("light"));
    ui->theme->addItem(QString("SXN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SXN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SXN-traditional"), QVariant("trad"));
...
void OptionsDialog::setModel(OptionsModel *model)
{
    ...
    /* Wallet */
    connect(ui->showSafenodesTab, SIGNAL(clicked(bool)), this, SLOT(showRestartWarning()));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->showSafenodesTab, OptionsModel::ShowSafenodesTab);
