    ...
    platformStyle(platformStyle)
{
    ...
    if (settings.value("fShowSafenodesTab").toBool()) {
        safenodeListPage = new SafenodeList(platformStyle);
        addWidget(safenodeListPage);
    }
...
void WalletView::setClientModel(ClientModel *clientModel)
{
    ...
    QSettings settings;
    if (settings.value("fShowSafenodesTab").toBool()) {
        safenodeListPage->setClientModel(clientModel);
    }
}
...
void WalletView::setWalletModel(WalletModel *walletModel)
{
    ...
    QSettings settings;
    if (settings.value("fShowSafenodesTab").toBool()) {
        safenodeListPage->setWalletModel(walletModel);
    }
...
void WalletView::gotoSafenodePage()
{
    QSettings settings;
    if (settings.value("fShowSafenodesTab").toBool()) {
        setCurrentWidget(safenodeListPage);
    }
}
