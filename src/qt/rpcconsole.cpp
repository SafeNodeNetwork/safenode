...
void RPCConsole::setClientModel(ClientModel *model)
{
    ...
    if (model && clientModel->getPeerTableModel() && clientModel->getBanTableModel()) {
        ...
        setSafenodeCount(model->getSafenodeCountString());
        connect(model, SIGNAL(strSafenodesChanged(QString)), this, SLOT(setSafenodeCount(QString)));
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the SafeNode RPC console.") + "<br>" +
...
void RPCConsole::setSafenodeCount(const QString &strSafenodes)
{
    ui->safenodeCount->setText(strSafenodes);
}
